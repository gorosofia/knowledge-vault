...
[![addyosmani%2Fagent-skills | Trendshift](https://camo.githubusercontent.com/3489766ff559ec9fe35f6319f97c8c5b98dc564644e5e683d2bfddbbf84c64f5/68747470733a2f2f7472656e6473686966742e696f2f6170692f62616467652f7265706f7369746f726965732f3235323030)](https://trendshift.io/repositories/25200)

[![Addy's Agent Skills](https://camo.githubusercontent.com/dd13a635ba936be31326ecf651ff2f7b198c9849cf048df4c51d825e95cedbf3/68747470733a2f2f616464796f736d616e692e636f6d2f6173736574732f696d616765732f61646479732d6167656e742d736b696c6c732e6a7067)](https://camo.githubusercontent.com/dd13a635ba936be31326ecf651ff2f7b198c9849cf048df4c51d825e95cedbf3/68747470733a2f2f616464796f736d616e692e636f6d2f6173736574732f696d616765732f61646479732d6167656e742d736b696c6c732e6a7067)
...
Put workflow skills under `.cursor/skills/` (sync from `agent-skills/skills/`) and short policies in `.cursor/rules/*.mdc` — do not paste full skills into rules. See [docs/cursor-setup.md](https://github.com/addyosmani/agent-skills/blob/main/docs/cursor-setup.md).
...
**Kiro IDE & CLI** Skills for Kiro reside under ".kiro/skills/" and can be stored under Project or Global level. Kiro also supports Agents.md. See Kiro docs at [https://kiro.dev/docs/skills/](https://kiro.dev/docs/skills/) **Codex**
...
Codex reads the root `skills/` directory directly through `.codex-plugin/plugin.json`. Once installed, invoke skills in chat using `@` (e.g., `@spec-driven-development`). See [docs/codex-setup.md](https://github.com/addyosmani/agent-skills/blob/main/docs/codex-setup.md) for local installation and troubleshooting.
...
Already installed? How you roll the pack out depends on your codebase. The **[Adoption Guide](https://github.com/addyosmani/agent-skills/blob/main/docs/adoption-guide.md)** covers two paths: the full lifecycle from day one for a greenfield project, or an incremental, verification-first rollout for an established codebase.
...
| [documentation-and-adrs](https://github.com/addyosmani/agent-skills/blob/main/skills/documentation-and-adrs/SKILL.md) | Architecture Decision Records, API docs, inline documentation standards - document the *why* | Making architectural decisions, changing APIs, or shipping features |
...
See [docs/agents.md](https://github.com/addyosmani/agent-skills/blob/main/docs/agents.md) for the decision matrix, orchestration rules, and how personas compose with skills and slash commands.
...
| Reference | Covers |
| --- | --- |
| [definition-of-done.md](https://github.com/addyosmani/agent-skills/blob/main/references/definition-of-done.md) | Project-wide standing bar every change clears, contrasted with per-task acceptance criteria |
| [testing-patterns.md](https://github.com/addyosmani/agent-skills/blob/main/references/testing-patterns.md) | Test structure, naming, mocking, React/API/E2E examples, anti-patterns (JavaScript/TypeScript) |
...
| [observability-checklist.md](https://github.com/addyosmani/agent-skills/blob/main/references/observability-checklist.md) | On-call questions, structured logging, RED/USE metrics, tracing, symptom-based alerting, pre-launch gate |
| [orchestration-patterns.md](https://github.com/addyosmani/agent-skills/blob/main/references/orchestration-patterns.md) | Endorsed multi-persona orchestration patterns, anti-patterns, and the "personas don't invoke personas" rule |
...
|  | Name | GitHub | Role |
| --- | --- | --- | --- |
| [![Addy Osmani](https://github.com/addyosmani.png?size=120)](https://github.com/addyosmani.png?size=120) | **Addy Osmani** |  | Creator |
| [![Federico Bartoli](https://github.com/federicobartoli.png?size=120)](https://github.com/federicobartoli.png?size=120) | **Federico Bartoli** | [@federicobartoli](https://github.com/federicobartoli) | Collaborator |
| [![Joan León](https://github.com/nucliweb.png?size=120)](https://github.com/nucliweb.png?size=120) | **Joan León** | [@nucliweb](https://github.com/nucliweb) | Collaborator |