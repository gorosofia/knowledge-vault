...
published:
created: 2026-07-28
description: "The job search that runs on your machine. AI job application framework built on Claude Code: evaluate postings, tailor CVs, write cover letters, prep interviews. Fork it and own it. - MadsLorentzen/ai-job-search"
tags:
  - "clippings"
---
[![Pip, the courier bird](https://github.com/MadsLorentzen/ai-job-search/raw/master/assets/mascot/pip_flight_loop.gif)](https://github.com/MadsLorentzen/ai-job-search/blob/master/assets/mascot/pip_flight_loop.gif)

## AI Job Search

*The job search that runs on your machine.*

[![MadsLorentzen%2Fai-job-search | Trendshift](https://camo.githubusercontent.com/45b4f6eb7dce41cb667494ce70a7597f288df37dc33dde0331193f7c8e147cb9/68747470733a2f2f7472656e6473686966742e696f2f6170692f62616467652f7472656e6473686966742f7265706f7369746f726965732f34333632322f6461696c79)](https://trendshift.io/repositories/43622?utm_source=trendshift-badge&utm_medium=badge&utm_campaign=badge-trendshift-43622)
...
[![Buy me a coffee at ko-fi.com](https://camo.githubusercontent.com/b83b435a0fbb41274d1021b0d2747ae96c34c69f8cb51cc339b3eb5bbcca75a9/68747470733a2f2f73746f726167652e6b6f2d66692e636f6d2f63646e2f6b6f6669332e706e673f763d36)](https://ko-fi.com/madslorentzen)
...
- [Claude Code](https://claude.com/claude-code) (CLI). Using a different agent tool (Codex, Antigravity, Gemini CLI)? Start at [`AGENTS.md`](https://github.com/MadsLorentzen/ai-job-search/blob/master/AGENTS.md) - the portal search skills work there out of the box, and [community forks](https://github.com/MadsLorentzen/ai-job-search/discussions/78) adapt the full workflow.
- Python 3.10+
- [Bun](https://bun.sh/) (for job search CLI tools)
- LaTeX distribution with `lualatex` and `xelatex`: [TeX Live](https://tug.org/texlive/), [MacTeX](https://tug.org/mactex/), [TinyTeX](https://yihui.org/tinytex/), or [MiKTeX](https://miktex.org/). The CV compiles with `lualatex` (pdflatex often fails on modern MiKTeX installs with `fontawesome5` font-expansion errors); the cover letter compiles with `xelatex` because `cover.cls` requires `fontspec`. If using a minimal TeX install such as TinyTeX or BasicTeX, install the extra packages listed in [SETUP.md](https://github.com/MadsLorentzen/ai-job-search/blob/master/SETUP.md#minimal-tex-install-tinytexbasictex).
...
Upstream moves fast. Rather than pulling raw `master` and hoping, update your fork to a tagged [release](https://github.com/MadsLorentzen/ai-job-search/releases) - a vetted checkpoint described in [CHANGELOG.md](https://github.com/MadsLorentzen/ai-job-search/blob/master/CHANGELOG.md). `python3 tools/check_upstream_updates.py` previews exactly which of your personalized files an update touches before you merge. Full walkthrough in [SETUP.md, section 8](https://github.com/MadsLorentzen/ai-job-search/blob/master/SETUP.md#8-pulling-upstream-updates-into-your-fork).
